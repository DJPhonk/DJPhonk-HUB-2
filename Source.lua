...
local Window = OrionLib:MakeWindow({Name = "DJPhonk Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "DJPhonk Hub"})
...
W:AddLabel("[+] DJPhonk Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "DJPhonk Hub(Noitification)",
